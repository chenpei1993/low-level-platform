...
@Component
public class EveryMonthConverter implements TaskConverter{
    @Override
    public List<TaskEntity> convert(TaskTypeEnum taskTypeEnum, LocalDateTime startDateTime, LocalDateTime endDateTime, LocalDateTime sendDateTime, SendTypeEnum sendType, String message) {
